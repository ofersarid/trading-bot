                    ...
                    if coin in mids:
                        ...
                        if prev is not None:
                            ...
                            if change != 0:  # Only show if changed
                                ...
                                print(
                                    f"⚡ {timestamp}  {coin:6} ${price:>12,.2f}  {arrow} {color_sign}{change:.2f}"
                                )
        ...
        async for message in ws:
            ...
            if data.get("channel") == "trades":
                ...
                for trade in trades:
                    ...
                    print(
                        f"{side_emoji} {timestamp}  {side_text} {size:>10.4f} {coin} @ ${price:,.2f}"
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("mode", choices=["prices", "trades", "orderbook"], help="What to stream")
    parser.add_argument(
        "coins", nargs="*", default=["BTC", "ETH"], help="Coins to watch (default: BTC ETH)"
    )
