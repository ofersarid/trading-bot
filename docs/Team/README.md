...
This folder contains documentation organized by team member persona. Each folder stores recommendations and analysis from the corresponding `/ask-*` cursor commands.
...
This creates a searchable knowledge base of decisions and rationale over time.
